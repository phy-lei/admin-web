...
function handleRemoveProductLadder(index, row) {
...
function handleAddProductLadder(index, row) {
  let productLadderList = value.productLadderList;
...
function handleRemoveFullReduction(index, row) {
...
function handleAddFullReduction(index, row) {
  let fullReductionList = value.productFullReductionList;
